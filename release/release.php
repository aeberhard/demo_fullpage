...
$relparams->ignore_root_files = ['.gitignore', '.TODO', '.todo.txt'];
// Addon-Unterverzeichnisse die nicht übernommen werden sollen
$relparams->ignore_folders = ['.git', 'bin', 'actions', 'modules', 'release', 'templates', 'vendor'];
